...
func TestField(t *testing.T) {
	t.Run("set_and_get", func(t *testing.T) {
		...
		value1 := rec.GetValue("value1")
		assert.NoError(t, value1.Error)
		assert.Equal(t, 100, value1.Get())
		value2 := rec.GetValue("value2")
		assert.NoError(t, value2.Error)
		assert.Equal(t, "value2_name", value2.Get())
		value3 := rec.GetValue("value3")
		assert.NoError(t, value3.Error)
		assert.Equal(t, 1.234, value3.Get())
